---
title: "How to build side projects while employed full-time"
...
It's three in the morning. You awoke with the next great startup idea. You hop on Namecheap and buy the domain. You fall back asleep excited to break code on the project tomorrow.

You wake up early, brew some coffee, and crack open VS Code. Today is the day.

With a fresh cup of coffee in hand, you crank out the data models. After creating some awesome draw.io diagrams you have a good idea of how you want to architect this system. It's not perfect, but it will do for a side project.
